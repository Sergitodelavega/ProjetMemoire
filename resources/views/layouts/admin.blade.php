                ...
                <nav class="navbar-mobile">
                    <div class="container-fluid">
                        <ul class="navbar-mobile__list list-unstyled">
                            ...
                            <li>
                                <a href="chart.html">
                                    <i class="fas fa-chart-bar"></i>Mémoires Déposés</a>
                            </li>
                            <li>
                                <a href="table.html">
                                    <i class="fas fa-table"></i>Mémoires Publiés</a>
                            </li>
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                    <i class="fas fa-copy"></i>Gestion des utilisateurs</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    <li>
                                        <a href="login.html">Activer un compte</a>
                                    </li>
                                    <li>
                                        <a href="register.html">Désactiver un compte </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <nav class="navbar-sidebar">
                        <ul class="list-unstyled navbar__list">
                            <li class="active has-sub">
                                <a class="js-arrow" href="{{ route('admin.home.index') }}">
                                    <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.memoire.index') }}">
                                    <i class="fas fa-chart-bar"></i>Mémoires Déposés</a>
                            </li>
                            <li>
                                <a href="table.html">
                            ...
                            <li>
                                <a href="{{ route('home.index') }}">
                                    <i class="fas fa-table"></i>Retour à la page d'accueil</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                                            ...
                                            <div class="mess-dropdown js-dropdown">
                                                ...
                                                <div class="mess__item">
                                                    <div class="image img-cir img-40">
                                                        <img src="{{ asset('back/images/icon/avatar-06.jpg') }}" alt="Michelle Moreno" />
                                                    </div>
                                                    <div class="content">
                                                ...
                                                <div class="mess__item">
                                                    <div class="image img-cir img-40">
                                                        <img src="{{ asset('back/images/icon/avatar-04.jpg') }}" alt="Diane Myers" />
                                                    </div>
                                                    <div class="content">
                                                        <h6>Diane Myers</h6>
                                        ...
                                        <div class="noti__item js-item-menu">
                                            ...
                                            <div class="email-dropdown js-dropdown">
                                                ...
                                                <div class="email__item">
                                                    <div class="image img-cir img-40">
                                                        <img src="{{ asset('back/images/icon/avatar-06.jpg') }}" alt="Cynthia Harvey" />
                                                    </div>
                                                    <div class="content">
                                                ...
                                                <div class="email__item">
                                                    <div class="image img-cir img-40">
                                                        <img src="{{ asset('back/images/icon/avatar-05.jpg') }}" alt="Cynthia Harvey" />
                                                    </div>
                                                    <div class="content">
                                                        <p>Meeting about new dashboard...</p>
                                                ...
                                                <div class="email__item">
                                                    <div class="image img-cir img-40">
                                                        <img src="{{ asset('back/images/icon/avatar-04.jpg') }}" alt="Cynthia Harvey" />
                                                    </div>
                                                    <div class="content">
                                                        <p>Meeting about new dashboard...</p>
